function analyze_simdata_exp2()

    %{
    A wrapper function that simulates data for the load & incentive
    manipulation experiment using manually set parameters values (not model
    fitted ones), and plot the figures

    USAGE: analyze_simdata_exp2()
