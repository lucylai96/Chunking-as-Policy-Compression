function policy_complexity_exp2()

    %{
    Plot the average policy complexity and reward-complexity curves in
    different blocks for the load & incentive manipulation experiment

    USAGE: policy_complexity_exp2()
